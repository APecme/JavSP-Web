...
[![Version](https://img.shields.io/badge/version-1.0.11-blue)](https://github.com/APecme/javsp-web/releases/tag/v1.0.11)
...
~~- ✅ **监控刮削**：监控指定目录，自动处理新添加的影片文件~~（需要大量测试暂时未完成）
~~- ✅ **定时刮削**：按计划定期触发刮削任务~~（需要大量测试暂时未完成）
